...
void opensbliblock00Kernel040(
    ...
    double rho_B0, double rho_RKold_B0,
    double rhou0_B0, double rhou0_RKold_B0,
    double rhou1_B0, double rhou1_RKold_B0,
    double rhou2_B0, double rhou2_RKold_B0,
    double rhoE_B0, double rhoE_RKold_B0,
    double rkA, double rkB,
    opensbliblock00Kernel040_result *out)
{
   double new_rho_RKold_B0 = rkA*rho_RKold_B0 + dt*Residual0_B0;
   double new_rho_B0 = rkB*new_rho_RKold_B0 + rho_B0;

   double new_rhou0_RKold_B0 = rkA*rhou0_RKold_B0 + dt*Residual1_B0;
   double new_rhou0_B0 = rkB*new_rhou0_RKold_B0 + rhou0_B0;

   double new_rhou1_RKold_B0 = rkA*rhou1_RKold_B0 + dt*Residual2_B0;
   double new_rhou1_B0 = rkB*new_rhou1_RKold_B0 + rhou1_B0;

   double new_rhou2_RKold_B0 = rkA*rhou2_RKold_B0 + dt*Residual3_B0;
   double new_rhou2_B0 = rkB*new_rhou2_RKold_B0 + rhou2_B0;

   double new_rhoE_RKold_B0 = rkA*rhoE_RKold_B0 + dt*Residual4_B0;
   double new_rhoE_B0 = rkB*new_rhoE_RKold_B0 + rhoE_B0;

   out->rho_B0 = new_rho_B0;
   out->rho_RKold_B0 = new_rho_RKold_B0;
   out->rhou0_B0 = new_rhou0_B0;
   out->rhou0_RKold_B0 = new_rhou0_RKold_B0;
   out->rhou1_B0 = new_rhou1_B0;
   out->rhou1_RKold_B0 = new_rhou1_RKold_B0;
   out->rhou2_B0 = new_rhou2_B0;
   out->rhou2_RKold_B0 = new_rhou2_RKold_B0;
   out->rhoE_B0 = new_rhoE_B0;
   out->rhoE_RKold_B0 = new_rhoE_RKold_B0;
}
